...
(function () {
  'use strict';
  describe('directive : form-fields', function () {
    var $compile,
    ...
    beforeEach(inject(function (_$compile_, _$rootScope_, _$httpBackend_, _$templateCache_) {
      ...
      element = $compile("<div><div form-fields field='field' ng-repeat='field in form.formFields'></div></div>")(scope);
      ...
      httpBackend.expect('GET', 'assets/locales/en.json')
        .respond({});
      httpBackend.expect('GET', 'app/components/form/templates/fields-templates/textfield.html')
        .respond(_$templateCache_.get('textfield.html'));
      scope.$digest();
    }));
